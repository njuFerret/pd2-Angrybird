...
GameItem::GameItem(b2World *world) : g_body(nullptr), g_world(world) {}

GameItem::~GameItem() { g_world->DestroyBody(g_body); }
...
void GameItem::paint() {
  ...
  g_pixmap.setRotation(-(g_body->GetAngle() * 180.0f / 3.14159f));
}
